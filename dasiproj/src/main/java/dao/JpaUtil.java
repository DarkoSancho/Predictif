...
public class JpaUtil {
     ...
     */
    public static final String PERSISTENCE_UNIT_NAME = "fr.insalyon.dasi.test_mavenproject2_jar_1.0-SNAPSHOTPU";
    /**
    ...
    public static EntityManager getEntityManager() {
        try  {
            ...
            log("Erreur lors de l'obtention de l'entity manager");
            throw ex;
        }
    }
    /**
     ...
     */
    public static synchronized void initialiserFabriqueContextePersistance() {
     ...
     * (ActionServlet) [projet Web Application].</strong>
     */
    public static synchronized void libererFabriqueContextePersistance() {
